...
class EnemySpawner {
    ...
    spawnEnemy() {
        ...
        // 根据难度和波次调整敌人属性
        const difficultyMultiplier = 1 + (this.difficulty - 1) * 0.1 + (this.wave - 1) * 0.05;
        ...
        // 生成特效
        this.createSpawnEffect(x, -50);
    }
    
    spawnBoss() {
        const x = this.game.canvas.width / 2 - 60;
        const boss = new Enemy(x, -100, 'boss', this.game);
        ...
        // BOSS出现特效
        this.createBossSpawnEffect(x, -100);
    }
